...
// unified CodeEditorDecorationProvider interface instead of being built in:
...
class SweetLineDecorationProvider final : public huxerui::codeeditor::CodeEditorDecorationProvider {
 public:
  ...
  huxerui::codeeditor::CodeEditorDecorationResult ProvideDecorations(
      const huxerui::codeeditor::CodeEditorDecorationContext& context
  ) override;
